	...
	*/
	...
	//National Sales Rankings			
     ...
     RANK(
		...
		DESCENDANTS(
				[Sales Geography].[Sales Geography].CurrentMember.Parent, Levels(@ChildMember)
			), 
			[Measures].[Sales MTD])		
	...
	//MTD Rankings
     ...
     RANK(
		[Sales Geography].[Sales Geography].CurrentMember, 
		DESCENDANTS(
				STRTOMEMBER(@SalesGeoMemberKey).Parent, Levels(@ChildMember)
			), 
			[Full Month PTQ])
	...
	MEMBER [Measures].[Sales QTD] as
		[Measures].[QTD Commissioned Sales TC] + + [Measures].[Net Open Orders TC]	 // [Measures].[OpenOrderAmt QTD]				
	...
	//National Growth Rankings
     ...
     RANK(
		...
		DESCENDANTS(
			...
			IIF( IsEmpty([Measures].[MTD Commissioned Sales Growth %]), -99999999.0, [Measures].[MTD Commissioned Sales Growth %])
		)	
     ...
     RANK(
		...
		DESCENDANTS(
			...
			IIF( IsEmpty([Measures].[QTD Commissioned Sales Growth %]), -99999999.0, [Measures].[QTD Commissioned Sales Growth %])
		)
     ...
     RANK(
		...
		DESCENDANTS(
			...
			IIF( IsEmpty([Measures].[YTD Commissioned Sales Growth %]), -99999999.0, [Measures].[YTD Commissioned Sales Growth %])
		)											
...
FROM [SalesOrders]
WHERE (
	//[Date Commissioned].[Calendar Time].[07/24/2016]
	STRTOMEMBER(@DateKey)
)